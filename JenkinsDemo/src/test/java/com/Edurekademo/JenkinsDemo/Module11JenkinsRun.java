package com.Edurekademo.JenkinsDemo;
...
public class Module11JenkinsRun {

	Logger logger = LogManager.getLogger(Module11JenkinsRun.class);
	...
	public void test() throws Exception {
		...
		Thread.sleep(10000);
		 ...
		 //driver.findElement(By.xpath("/html/body/app-root/app-onboarding-main/div/div/div[1]/div[2]/div[2]/app-onboarding-personal-details/div[2]/div/div/div[2]/div[1]/input")).click();
		 logger.info("Wait for the Open Browser and Display the WebElement");
		Thread.sleep(10000);
	logger.info("Upload the Image into the Application");
		Runtime.getRuntime().exec("C:\\Users\\vbyrappa\\Desktop\\FileUploader.exe");
	 logger.info("Wait for the Open Browser and Display the WebElement");
		Thread.sleep(10000);
